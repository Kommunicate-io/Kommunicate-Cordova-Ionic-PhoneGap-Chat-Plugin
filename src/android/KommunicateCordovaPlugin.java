...
public class KommunicateCordovaPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("login")) {
            ...
            try {
                ...
                new KmConversationBuilder(cordova.getActivity())
                        .setKmUser(user)
            ...
            try {
                final JSONObject jsonObject = new JSONObject(data.getString(0));
                new KmConversationInfoTask(context, jsonObject.getString("clientChannelKey"), new KmGetConversationInfoCallback() {
                    @Override
    ...
    private boolean isSkipConversationList(JSONObject jsonObject) {
        try {
            return jsonObject.has("skipConversationList") && jsonObject.getBoolean("skipConversationList");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return false;
